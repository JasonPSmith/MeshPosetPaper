...
\subfigure{\patt{1}{2}{1,2}[0/2,2/2][][][][]}
\patt{1}{3}{1,2,3}[0/0,0/2,0/3,1/3,1/1,1/2,2/1,2/2,3/3][][][][]
\colpatt{1}{3}{1,2,3}[0/0,0/2,0/3,1/3,1/1,1/2,2/1,2/2,3/3][2/2,3/3][3/3,0/2,0/3,1/3,1/2]
\caption{A mesh pattern with an occurrence of $12^{(0,2),(2,2)}$ shown in red, but does not contain $12^{(0,0),(1,1),(2,2)}$ due to a point and does not contain $12^{(1,1),(2,1)}$ due to a lack of shadings.}\label{fig:occEx}
\end{figure}
